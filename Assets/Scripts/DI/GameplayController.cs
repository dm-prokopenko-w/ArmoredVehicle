...
namespace GameplaySystem
{
    public class GameplayController : IStartable
    {
        ...
        public void Start()
        {
            ...
            _itemController.PlayAnim(AnimatorViewID + AnimatorObject.CameraAnimator, StartStateCamera);
        }
        ...
        private void UpdateGame(bool value)
        {
            ...
            if (_isPlayGame)
            {
                ...
                _itemController.PlayAnim(AnimatorViewID + AnimatorObject.CameraAnimator, GameStateCamera);
            }
            else
            {
                _itemController.PlayAnim(AnimatorViewID + AnimatorObject.CameraAnimator, StartStateCamera);
